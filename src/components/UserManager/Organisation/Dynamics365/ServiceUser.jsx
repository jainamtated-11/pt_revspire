...
const ServiceUser = () => {
  ...
  const handleReconnect = async () => {
      ...
      try {
        ...
        if (authData.authUrl) {
          ...
          if (
            ...
            resolve("Dynamics 365 data synchronized successfully.");
          } else {
    ...
    toast.promise(DynamicsAuthorization, {
      ...
      success: "Dynamics connection authorized successfully!",
  ...
  return (
    <div className="p-4 m-2 border rounded-b-lg shadow-md">
      {console.log("I AM GETTING INSIDE TIS ")}
      {disconnectDialog && (
        <WarningDialog
            ...
            {dropdownOpen && (
              ...
              >
                ...
                >
                  {!error &&
                    serviceUserData &&
                    serviceUserData[0].crm == "Dynamics 365" && (
                      <>
                        <li>
                          <button
                            onClick={() => {
      ...
      {loading ? (
        ...
        <>
          <div className="pb-4">
            Existing Service User is from different CRM other than Dynamics 365.{" "}
            <br />
            Connect New to use Dynamics 365 as Service User.
          </div>
        </>
      )}
      {showConnectServiceUserDialog && (
