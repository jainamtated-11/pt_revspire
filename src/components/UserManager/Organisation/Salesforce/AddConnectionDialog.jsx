...
function AddConnectionDialog({
  ...
  const handleStep2Submit = async () => {
    ...
    try {
      ...
      if (response.data.message === "Record created in crm_connection table successfully.") {
        ...
        console.log(`id: ${connectionID}, path: ${encodedOriginURL},viewer_id: ${viewer_id}`);

        const authResponse = await axiosInstance.get(`/salesforce-authorisation`, {
          params: {
        ...
        console.log("authURL: ", authData.authUrl);
